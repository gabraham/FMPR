 ...
 *
 */
void groupridge_threshold(double *x, double *y, double *b,
      int *N_p, int *p_p, int *K_p,
 ...
 *
 */
void groupridge_warm(double *x, double *y, double *b, double *LP,
      int *N_p, int *p_p, int *K_p,
      double *lambda1, double *lambda2, double *lambda3_p,
      int *G, int *maxiter_p, double *eps_p, int *verbose_p,
      int *status, int *iter_p)
 ...
 *
 */
void groupridge_weighted(double *x, double *y, double *b,
      int *N_p, int *p_p, int *K_p,
      double *lambda1, double *lambda2, double *lambda3_p,
